...
public class YourOwnCircularArrayFIFOQueueTests {
    ...
    public void test_add_isFull_throwsException() {
        ...
        queue.add(20);
        queue.add(10);
        assertThrows(IllegalStateException.class, () -> queue.add(0));
        assertThrows(IllegalStateException.class, () -> queue.add(-1));
    }
    ...
    public void test_addNext_cyclesEntireQueue_returnsCorrect() {
        ...
        queue.add(25);
        queue.add(15);
        assertEquals(queue.next(), 5);
        assertEquals(queue.next(), 25);
        assertEquals(queue.next(), 15);
    }
